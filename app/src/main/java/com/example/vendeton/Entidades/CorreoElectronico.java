...
public class CorreoElectronico implements Parcelable {
    ...
    public String cor_usuario, cor_dominio, cor_correo;
    public int cor_id;
    public long con_identificacion;

    public CorreoElectronico(String cor_usuario, String cor_dominio, String cor_correo, int cor_id, long con_identificacion) {

...
public class activity_reportes_materiales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportes_materiales);

        imageButtonAtras = findViewById(R.id.imageButtonAtras10);

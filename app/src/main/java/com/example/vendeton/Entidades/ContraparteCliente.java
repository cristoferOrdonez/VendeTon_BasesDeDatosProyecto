...
public class ContraparteCliente {

    public String con_nombre , con_apellido, con_calle, con_barrio, con_ciudad, con_direccion;
    public long con_identificacion;

    public ContraparteCliente(long con_identificacion, String con_nombre, String con_apellido, String con_calle, String con_barrio, String con_ciudad, String con_direccion) {
